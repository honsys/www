...
echo default tomcat port 8080 is poduction backend \(other option is reclease cadidate 'rc' port 8090\)
echo establish release via redmine, jruby and java versions \(and maybe tomcat version\)
set host = ${HOST:r}
set jrb = '1.7.10' ; set jre = '1.7' 
set apollo = '1.6.0'
set tomcat = '7.0.52'
#set tomcat = '8.0.3' 
set redmine = '2.4.3' ; 
...
set opt = "show"
if ( "$1" != "" ) set opt = "$1"
set envlist = 'WWW_HOME ASSETS APOLLO_HOME CATALINA GEMFILE HUDSON_HOME HUDSON_OPTS JAVAREL JAVA_HOME JENKINS_HOME JRUBY JRUBY_HOME JRUBY_OPTS JRUBYREL JXX_OPTS JYTHON_HOME NODE_HOME NODE_PATH NODE_ENV RAILS_ENV RCCATALINA REDMINE_LANG REDMINEREL REDMJNE SCM_HOME SCM_OPTS SOLR_HOME SOLR_DATA SOLR_OPTS TOMCAT_HOME TOMCATREL TOMCAT JAVA_OPTS'
